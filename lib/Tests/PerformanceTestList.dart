...
class PerformanceTestList extends StatefulWidget {
  final String memberId;

  const PerformanceTestList({super.key, required this.memberId});

  @override
  _PerformanceTestListState createState() => _PerformanceTestListState();
}

class _PerformanceTestListState extends State<PerformanceTestList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Ölçümler", style: TextStyle(color: Colors.white)),
              ...
              return Center(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8),
                    Text(
                      "Yeni ölçüm eklemek için + butonunu kullanabilirsiniz.",
                      style: TextStyle(
            ...
            trailing: Row(
              ...
              children: [
                IconButton(
                  ...
                  onPressed: () {
                    _generateAndSavePdf(test['test'], test);
                  },
                ),
                IconButton(
                  icon: Icon(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: _buildDetails(test['test'], test),
                          ),
                        ),
                      ],
                    ),
